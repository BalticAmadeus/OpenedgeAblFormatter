...
_request implements iGalacticDesign   :  
    ...
    define public property AndromedaDynamic as char no-undo init "Dynamic":U
        get.
    define public property CassiopeiaStatic as char no-undo init "Static":U
        get.
    define public property LyraNative as char no-undo init "Native":U
        get.    
    define public property PegasusRepository as char no-undo init "Repository":U
        get.    
        
    define public property SiriusNewName as character no-undo
        get.
        protected 
        set. 
    define public property VegaLink as character no-undo
        get.
        private    set. 
    define public property AltairSaved as logical no-undo
        get.
        private    set.
    define public property CygnusRepositoryObject as logical no-undo
        get.
        private set.
    define public property AquariusDynamic as logical no-undo
        get.
        private set.
    define public property DracoNative as logical no-undo
        get.
        private set.
