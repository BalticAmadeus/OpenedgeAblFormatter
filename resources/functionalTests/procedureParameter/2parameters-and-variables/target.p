...
define VARIABLE qbf33-2        AS LOGICAL   NO-UNDO INIT TRUE. /* dbase-2? */
define VARIABLE qbf124-c       AS CHARACTER NO-UNDO. /* scrap */
define VARIABLE qbf124124124-i AS INTEGER   NO-UNDO. /* scrap */