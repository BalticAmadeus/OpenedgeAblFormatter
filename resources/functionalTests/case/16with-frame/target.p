...
CASE vButton:
    WHEN "Search":U THEN DO WITH FRAME {&FRAME-NAME}:
        ...
        FIND FIRST Customer WHERE
                   Name >= vName share-LOCK NO-ERROR.
        IF NOT AVAILABLE (Customer) THEN FIND FIRST Customer USE-INDEX Name share-LOCK NO-ERROR.
        IF NOT AVAILABLE (Customer) THEN Name:SCREEN-VALUE = "*** NO RECORDS ***":U.
    END.
END CASE.