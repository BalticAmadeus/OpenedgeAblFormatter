...
![Formatter in action](https://github.com/BalticAmadeus/OpenedgeAblFormatter/blob/develop/resources/Formatter_in_action.gif)
![Formatter in action2](./resources/Formatter_action.gif)
