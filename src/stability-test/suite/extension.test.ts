...
// import { FormatterFactory } from "../../formatterFramework/FormatterFactory";
...
// // Enable all formatters and get instances
...
//     ? new MetamorphicEngine<Tree>(console)
//           .addMR(new ReplaceEQ())
...
//         // Only run metamorphic AST testing if enabled and engine is defined
//         if (isMetamorphicEnabled && metamorphicEngine) {
//             // Metamorphic AST testing integration
//             metamorphicEngine.setFormatFunction((input, eol) =>
//                 generateAst(input)
//             );

//             // Add input/output pairs for metamorphic testing
//             stabilityTestCases.forEach((testCase) => {
//                 return metamorphicEngine.addNameInputAndOutputPair(
//                     testCase,
//                     { eolDel: "\n" },
//                     { text: testCase, tree: generateAst(testCase) },
//                     { text: testCase, tree: generateAst(testCase) }
//                 );
//             });

//             const results = metamorphicEngine.runAll();
...
//                     "expected" in result
//                 ) {
//                     if (!compareAst(result.actual, result.expected)) {
//                         analyzeAstDifferences(
//                             result.actual,
//                             result.expected,
//                             result.fileName
//                         );
...
// function generateAst(text: string): Tree {
//     const tree = parserHelper.parse(new FileIdentifier("test", 1), text).tree;
//     if (!tree) {
//         throw new Error("Failed to generate AST from input text.");
//     }
//     return tree;
// }
